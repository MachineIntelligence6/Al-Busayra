        ...
        <Box sx={{ px: 3, pb: 2, mt: -5 }}>
          <Box sx={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
            ...
            <Avatar
                ...
                sx={{ width: 100, height: 100, border: '4px solid white', borderRadius:"10px",  }}
              />
              <IconButton
                sx={{
                  position: 'absolute',
...
Procced
      ...
      <Box sx={{ 
        ...
        <Box sx={{ width: 'calc(50% - 8px)', height: '100%' }}>
          <GeneralInfoView profile={profile} onEdit={() => handleEdit('General Info')} />
        </Box>
        <Box sx={{ width: 'calc(50% - 8px)', height: '100%' }}>
          <ContactInfoView  profile={profile} onEdit={() => handleEdit('Contact Info')} />
        </Box>
        <Box sx={{ width: 'calc(50% - 8px)', height: '100%' }}>
          <DrivingLicenseView profile={profile} onEdit={() => handleEdit('Driving License')} />
        </Box>
        <Box sx={{ width: 'calc(50% - 8px)', height: '100%' }}>
          <PassportDetailsView profile={profile} onEdit={() => handleEdit('Passport Details')} />
        </Box>
        <Box sx={{ width: 'calc(50% - 8px)', height: '100%' }}>
