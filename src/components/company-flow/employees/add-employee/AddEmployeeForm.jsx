        ...
        <Box >
            ...
            <Box sx={{ width: "100%", my: 5 }}>
                ...
                {formtabs?.map(item => {
                    return (
                        <>
                            {item.isActive && item.text === "Add Employee" && <EmploypeeForm />}
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: 'center', pt: 2, pb: 4 }}>
                ...
                <Box component="div" sx={{ display: 'flex', alignItems: 'center', gap: 1 }} >
                    <CustomButton endIcon={<Check size={20} />} onClick={handleNextClick}>{Boolean(selectedTab?.text === "C3 Card") ? "Save" : "Next"}</CustomButton>
                </Box>
            </Box>
        </Box>
