...
const FoodPermitDeductionMainTable = ({ onTopBtnClick, onViewModal }) => {
    ...
    return (
        <Box>
            <CompanyHeader btnProps={{ text: "Food Permit Deduction", icon: null, onClick: onTopBtnClick }}>
                <DescriptiveText
            ...
            <Box sx={{ p: 2 }}>
                ...
                <CustomTable columns={columns} data={mainTableData} headTextTransform='upperCase' />
            </Box>
        </Box>
    )
}
