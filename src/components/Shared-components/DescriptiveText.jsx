...
const DescriptiveText = (props) => {
    ...
    return (
        ...
        <Box component="span" >
            <Typography component="p" fontSize={fontSize} letterSpacing={letterSpacing} fontWeight={fontWeight} position="relative" width={"fit-content"} sx={{ color: color, ...sx }} {...props}>
                {text}
