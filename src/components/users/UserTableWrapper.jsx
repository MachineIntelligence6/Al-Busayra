...
const UserTableWrapper = ({
  ...
  const menuConfigurations = useMemo(
    () => ({
      activeUser: {
        menuItems: [
          { label: "Permissions", route: "/users/active-users/permissions" },
          { label: "View Details", route: "/users/active-users/view-details" },
          { label: "Edit Details", route: "/users/active-users/view-details" },
        ],
      },
    }),
    []
  ...
  const currentMenuConfig = useMemo(() => {
    if (pathname.includes("users/active-users") || pathname.includes("users/inactive-users"))
